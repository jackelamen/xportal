              ...
              {invoices.map((inv) => (
                <div key={inv.id}>
                  <div className="flex flex-wrap items-center gap-3 px-3.5 py-2.5 text-sm">
                    ...
                    <Money amount={inv.amount} currency={inv.currency} locale="en" className="font-data" />
                      ...
                      {lineItemsByInvoice[inv.id].map((li) => (
                        <li key={li.id} className="flex items-center gap-2 py-0.5">
                          ...
                          <span className="font-data text-ink-muted">
                            {li.quantity} × <Money amount={li.unit_price} currency={inv.currency} locale="en" />
                          </span>
                          <Money amount={li.quantity * li.unit_price} currency={inv.currency} locale="en" className="font-data w-20 text-right" />
                        </li>
                      ))}
                    </ul>
                  )}
