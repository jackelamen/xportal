...
export default function MessageFeed({ projectId, invoiceId = null, messages }) {
            ...
            <Fragment key={m.id}>
              ...
              >
                <span
                  ...
                  title={m.sender_name || (fromTeam ? "Project team" : "You")}
                >
                ...
                <div className={`min-w-0 max-w-[80%] ${fromTeam ? "" : "text-right"}`}>
                  <p className={`flex items-center gap-2 text-xs text-ink-muted ${fromTeam ? "" : "justify-end"}`}>
                    <span className="font-medium text-ink-soft">
                      {m.sender_name || (fromTeam ? "Project team" : "You")}
                    </span>
